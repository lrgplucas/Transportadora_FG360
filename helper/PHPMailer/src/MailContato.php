    ...
    <section style=' padding:10px 50px;'> <div class='container-fluid'  padding:2px'>
         ...
         <p class='email-login-dados'><b>EMAIL:</b>".$email."</p>
          <p class='email-login-dados'><b>TELEFONE:</b>".$tel."</p>  
            ...
            "<span class='sr-only' style='color:white;'>Fa</span><a href='https://www.facebook.com/FG-360-Transportes-571421250024615/' class='footer-link'><img class='footer-img' style='width:auto;height:auto;' src='https://fg360transportes.com.br/imgs/social/facebook_icon.png' alt=''></a> </li> <li style='display:inline;'><span class='sr-only' style='color:white;'>Instagram</span><a href='https://www.instagram.com/fg360transportes' class='footer-link'><img style='width:auto;height:auto;' class='footer-img' src='https://fg360transportes.com.br/imgs/social/instagram_icon.png' alt=''></a></li></ul></footer></body> </html>";
	$mail->send();
