...
<div class='col-6 d-flex align-items-center' style='background-color: #fab432; color: #fff; font-size: .8rem; border-radius: 0; text-transform: uppercase; font-weight: 700;width:20%;'> 
            ...
            <h1 class='email-body-top-title' style='color:#000;'>Ol&aacute;, <b>$nome</b> seu cadastro foi atualizado em nosso site.</h1>
            <p class='email-body-top-text' style='color:#000;'>Agora voc&ecirc; pode acessar suas faturas, CTE's e solicitar segunda via de boletos.</p>
        </div>
    </section><section class='email-login' style='padding: 25px 0;'><div class='container-fluid'>
...
try{
    ...
    $mail->Subject = "Atualização Cliente";
    $mail->CharSet = 'UTF-8';
    $mail->IsHTML(true); 
    $mail->Body = $body;
    $mail->send();
