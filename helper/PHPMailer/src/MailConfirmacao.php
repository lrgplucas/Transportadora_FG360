...
<!--================ Navbar Menu Fim =================-->
  ...
  <body style='background-color:white;width:500px' >
	...
	<center style='position:relative;'>
		...
		<h1 style='color:black;'>PARAB&Eacute;NS</h1>
		
		<p style='color:black;'>Sua reserva foi conclu&iacute;da com sucesso</p>
		<p style='color:black;'>Ficamos felizes em informar-lhe de que recebemos sua reserva.</p>
	...
	<div style='background-color:gainsboro;'>
		<div  style=''>
			...
			<span style='margin-left:70%;font-weight:bold' >R$ 30,00</span>
...
try{
	...
	//$mail->AddEmbeddedImage('www.hostel78.com.br/imgs/banner/banner_02.jpg', 'img');
