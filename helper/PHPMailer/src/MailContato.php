...
try{
    ...
    $mail->CharSet = 'UTF-8';
    $mail->IsHTML(true); 
    $mail->Body  = "<html><body style='max-width: 500px; margin: 0 auto;'> 
    <section style='max-width: 180px;'> <div class='container'> <div class='row'>
    <div class='col-6'> <img src='https://fg360transportes.com.br/imgs/logotipo.png' class='email-header-logo' alt=''> </div> 
    <div class='col-6 d-flex align-items-center' style='background-color: #fab432; color: #fff; font-size: .8rem; border-radius: 0; text-transform: uppercase; font-weight: 700;float:right,width:20%;'> 
     </div>  </div> </div> </section> 
    <section style=' padding:10px 50px;'> <div class='container-fluid'  padding:2px'>
         <p class='email-login-dados'><b>MENSAGEM:</b> ".$msg."</p> 
         <p class='email-login-dados'><b>NOME:</b> ".$nome."</p> 
         <p class='email-login-dados'><b>CPF:</b> ".$doc."</p> 
         <p class='email-login-dados'><b>EMAIL:</b>".$email."</p>
          <p class='email-login-dados'><b>TELEFONE:</b>".$tel."</p>  
            <p class='email-login-dados'><b>NOME DO CONTATO:</b> ".$contato."</p>   
            <p class='email-login-dados'><b>CELULAR:</b>".$celular."</p>
            <p class='email-login-dados'><b>CIDADE:</b>".$cidade."</p>
            <p class='email-login-dados'><b>ESTADO:</b>".$estado."</p></div> </section> <section class='email-body-bottom mt-3 mb-3'><div class='container'><center><p class='email-body-bottom-text'>Ficou alguma d&uacute;vida?</p> <p class='email-body-bottom-contato'>Entre em contato: contato@fg360transportes.com.br</p> <p class='email-body-bottom-contato'>(12) 3655-3099 ou (12) 9 8275-0506</p> </center></div> </section>".
            " <footer style='background-color:white; color: #fff; padding: 2rem;'><ul style='padding:0; list-style:none;  flex-direction:row;justify-content:center;background-color:white;text-align: center;'> <li style='display:inline;'>".
            "<span class='sr-only' style='color:white;'>Fa</span><a href='https://www.facebook.com/FG-360-Transportes-571421250024615/' class='footer-link'><img class='footer-img' style='width:auto;height:auto;' src='https://fg360transportes.com.br/imgs/social/facebook_icon_black.png' alt=''></a> </li> <li style='display:inline;'><span class='sr-only' style='color:white;'>Instagram</span><a href='https://www.instagram.com/fg360transportes' class='footer-link'><img style='width:auto;height:auto;' class='footer-img' src='https://fg360transportes.com.br/imgs/social/instagram_icon_black.png' alt=''></a></li></ul></footer></body> </html>";
	$mail->send();
