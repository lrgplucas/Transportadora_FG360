...
try{
    ...
    $mail->CharSet = 'UTF-8';
    $mail->IsHTML(true); 
	$mail->Body  = "<html><head><title>FG360 - Email Contato</title> </head> <body style='max-width: 500px; margin: 0 auto;'> <section style='max-width: 180px;'> <div class='container'> <div class='row'><div class='col-6 d-flex align-items-center' style='background-color: #fab432; color: #fff; font-size: .8rem; border-radius: 0; text-transform: uppercase; font-weight: 700;float:right'> <a href='http://transportadora-gf360.000webhostapp.com/' class='btn btn-custom-email' style='    text-decoration: none;    display: inline-block; color:#fff'>Acessar sou cliente</a> </div>  <div class='col-6'> <img src='http://transportadora-gf360.000webhostapp.com/imgs/logotipo.png' class='email-header-logo' alt=''> </div> </div> </div> </section> <section style='background-color:#d1d1d1; padding:10px 50px;'> <div class='container-fluid' style='background-color:gainsboro; padding:2px'> <p class='email-login-dados'><b>MENSAGEM:</b> ".$msg."</p> <p class='email-login-dados'><b>NOME:</b> ".$nome."</p> <p class='email-login-dados'><b>EMAIL:</b>".$email."</p> <p class='email-login-dados'><b>TELEFONE:</b>".$tel."</p> </div> </section> <section class='email-body-bottom mt-3 mb-3'> <div class='container'> <h2 class='email-body-bottom-title mb-3' style='font-size: .8rem;text-align: center;'>Clique no bot&atildeo Acessar sou cliente para ser direcionado para nosso site</h2> <center><p class='email-body-bottom-text'>Ficou alguma d&uacutevida?</p> <p class='email-body-bottom-contato'>Entre em contato: contato@fg360transportes.com.br</p> <p class='email-body-bottom-contato'>(12) 3655-3099 ou (12) 9 8275-0506</p> </center></div> </section> <footer style='background-color:#000; color: #fff; padding: 2rem;'><ul style='margin:0; padding:0; list-style:none; display:flex; flex-direction:row;justify-content:center;background-color:#000;margin-right:15%'> <li> <a href='https://www.facebook.com/FG-360-Transportes-571421250024615/' class='footer-link'> <img class='footer-img' style='width:auto;height:auto;' src='http://transportadora-gf360.000webhostapp.com/imgs/social/facebook_icon.png' alt=''> </a> </li> <li> <a href='https://www.instagram.com/fg360transportes' class='footer-link'>  <img style='width:auto;height:auto;' class='footer-img' src='http://transportadora-gf360.000webhostapp.com/imgs/social/instagram_icon.png' alt=''> </a> </li> </ul></footer></body> </html>";
	$mail->send();
